...
import themeRes from './themesArrSlim.json';
...
const TextAreaProvider = (props) => {
  ...
  const [textAnalyticsStore, textAreaDispatch] = useReducer(
    reducer,
    initialContext
  );
...
export { TextAreaProvider, Consumer as TextAreaConsumer, TextAreaContext };
