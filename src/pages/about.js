    ...
    <Layout>
      <section className="about-section">
        ...
        <p>
          ...
          recently learned. I also always enjoy communicating my understanding
          of new ideas I've learned to someone else.
        </p>
        <p>
          ...
          delivery of data-intensive web applications, leadership and methods
          for categoriing and approaching 'types' of problems in an org...
        </p>
      </section>
      <section className="about-section">
        <h2>A Do-er</h2>
        <p>
          I am restless if I'm not intentionally getting something done, or on
          my way to doing something. Even my down time is intentional, focused
          on connecting with my wife and/or friends, considering future plans...
      ...
      <section className="about-section">
        ...
        <p>
          ...
          beyond first crack in about 8 and a half minutes brewed in a Chemex.
        </p>
      </section>
      <section className="about-section">
        <h2>An INTJ</h2>
        ...
        <p>
          The way I process the info around me is more imaginative than
          practical. Some folks prefer the clarity from ther 5 senses. I do
          enjoy imagining the future of what could be and comparing my sensory
          input to my memories.
        </p>
        <p>
        ...
        <p>
          ...
          the path along the way. THis is complex for me, as the seeming nature
          of the work I am in is constantly changing, anad I try to look to
          those who've gone before me as trusted voices for insights.
        </p>
      </section>
      <section className="about-section">
        ...
        <p>
          ...
          both for myself and when working with others has made a drastic
          positive impact on my life. I work to understand the positive aspects
          of others' personalities on interpersonal and team dynamics.
        </p>
      </section>
