...
- Some web-app examples, thoughts, and details
  - scrollytelling 
  - a user-editable "dashboard" layout
  - real-time charts & data updates
...
- Websocket Chat App
  - an api using websockets to
  - a UI that ties into api-available socket events
- Strengths Kids-Drawing Tool
  - enter some strengthsfinder talents
  - see a child-like "drawing" to represent talent "domains"
- Empirical Effort-Measuring App
  - a tool for a team to identify and gather work "categories"
  - a tool for a team to collectively estimate complexity based on working "categories" and "points" of complexity
