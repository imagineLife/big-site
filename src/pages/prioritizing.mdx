...
These attributes, in and of themselves, are only as meaningful as the org agrees. Adopting prioritization frameworks that offer attributes that are not important to the folks in the org will reveal a misalignment between the org and the tool, and will render the prioritization tool useless.  
