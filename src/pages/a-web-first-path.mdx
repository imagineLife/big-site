...
- **REST APIs**: Manage Data for the web through http methods & C.R.U.D (_create,readu,update,delete_) operations
...
- **OS with Linux**: The CLI, text editors in the command line, file manipulation, streams, pipes, permissions...
