...
export default {
  lines: [
    {
      coordinates: mockSentimentLineData,
    },
    // ...could add another line here
  ],
  size: [700, 400],
  ...
  axes: [
    ...
    {
      orient: "bottom",
      label: { name: "Sentence Index", locationDistance: 55 },
    },
  ],
  showLinePoints: true,
}

export { mockSentimentLineData }