    ...
    'python-for-data-science': [
      ...
      },
      {
        ...
        tags: [
          ...
          'independent events',
          'Python probability calculations',
        ],
        excerpt:
      ...
      },
      {
        ...
        tags: [
          ...
          'similarity measures tutorial',
          'collaborative filtering',
          'Python movie recommendations',
        ],
        excerpt:
    ...
    eda: [
      {
        ...
        title: 'Analyzing Honey Production: EDA with Python',
        tags: [
          'data analysis',
    ...
    'intro-to-ml': [
      {
        ...
        excerpt:
          'Build a linear regression model using scikit-learn to predict Boston housing prices. Learn how to analyze real estate data, explore key features, and evaluate model performance.',
      },
      {
