...
- collections might be "modeled" after application use-cases, maybe web-app "pages" `(db.warehouseManager.find({_id:"Joe"}))`, which is a different "common sense" approach to a datastore than the rdbms approach
